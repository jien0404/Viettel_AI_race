...
if __name__ == '__main__':
    # Tạo một file dummy main.md để kiểm thử
    dummy_content = """
# Đây là Tiêu đề chính

Đây là đoạn văn bản giới thiệu đầu tiên. Nó mô tả nội dung của tài liệu.

## Một Tiêu đề phụ

Đây là đoạn văn bản thứ hai, nằm dưới tiêu đề phụ.
...
Một đoạn văn bản khác nằm giữa bảng và công thức.

$$
E = mc^2
$$

Đây là đoạn văn bản cuối cùng.
"""
    dummy_file_path = "dummy_main.md"
    with open(dummy_file_path, "w", encoding="utf-8") as f:
        f.write(dummy_content)

    print(f"--- Bắt đầu phân tích file '{dummy_file_path}' ---")
    parsed_blocks = parse_document(dummy_file_path)

    import json
    print(json.dumps(parsed_blocks, indent=2, ensure_ascii=False))
    print(f"\n--- Phân tích hoàn tất. Tổng số khối: {len(parsed_blocks)} ---")